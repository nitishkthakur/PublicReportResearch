...
react_prompt_meta = DEFAULT_REACT_AGENT_SYSTEM_PROMPT_TEMPLATE = """
...
# Create a LangChain-compatible version of the same prompt
react_meta_langtemplate = ChatPromptTemplate.from_messages([
    SystemMessagePromptTemplate.from_template("""You are an expert assistant who can solve any task using tool calls. You will be given a task to solve as best you can.
To do so, you have been given access to the following tools: {tool_names}
